...
const Modal = () => {
  ...
  return (
    showModal && (
      <div className="ml-5 z-50 fixed bottom-24 right-10 bg-dark-gray text-white bg-opacity-80 backdrop-blur-xl max-w-lg p-5 rounded-xl overflow-hidden font-montserrat font-medium text-[15px] border-[1px] border-light-gray border-opacity-30">
        <p className=" mb-5">
